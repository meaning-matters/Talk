...
export APP_CFLAGS := -DPJ_AUTOCONF=1\
	-O2 -Wno-unused-label -I/Users/case/Projects/Talk/Talk/External/pjproject-2.0.1/../OpenSSL-for-iPhone//include/ -DPJ_SDK_NAME="\"iPhoneOS6.0.sdk\"" -arch armv7s -isysroot /Applications/XCode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS6.0.sdk -DPJ_IS_BIG_ENDIAN=0 -DPJ_IS_LITTLE_ENDIAN=1\
	$(PJ_VIDEO_CFLAGS) \
...
export APP_LDFLAGS := -L$(PJDIR)/pjlib/lib\
	...
	$(PJ_VIDEO_LDFLAGS) \
	-L/Users/case/Projects/Talk/Talk/External/pjproject-2.0.1/../OpenSSL-for-iPhone//lib/ -lcrypto -lssl -arch armv7s -isysroot /Applications/XCode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS6.0.sdk -framework AudioToolbox -framework Foundation
