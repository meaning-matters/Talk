...
static NSString*    KeychainUtilityErrorDomain = @"KeychainUtilityErrorDomain";
                              ...
                              error:(NSError**)error
{
    ...
    if (status != noErr)
    {
        ...
        if (error != nil && status != errSecItemNotFound)
        {
            ...
            *error = [NSError errorWithDomain:KeychainUtilityErrorDomain code:status userInfo:nil];
        }
    ...
    if (status != noErr)
    {
        if (status == errSecItemNotFound)
        {
            ...
            if (error != nil)
            {
                *error = [NSError errorWithDomain:KeychainUtilityErrorDomain code:-1999 userInfo:nil];
            }
        }
        else
        {
